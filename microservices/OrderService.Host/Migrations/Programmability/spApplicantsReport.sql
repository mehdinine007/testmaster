...
begin
		...
		from [carsupply-test-company]..ClientsOrderDetailByCompany cod 
		...
		inner join [carsupply-test-company]..CompanyPaypaidPrices cp on cod.Id = cp.ClientsOrderDetailByCompanyId
