...
namespace OrderManagement.EfCore.Migrations
{
    ...
    [Migration("20240226082020_Change_IsComplete_Type_SeasonCompanyProduct")]
    partial class Change_IsComplete_Type_SeasonCompanyProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderManagement.Domain.Bases.OrderDeliveryStatusTypeReadOnly", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Title_En = "ReceivingContractRowId"
                        },
                        new
                        {
                            Id = 6,
                            ...
                            Title = "تکمیل وجه",
                            Title_En = "ReceivingAmountCompleted"
                        });
                });
            ...
            modelBuilder.Entity("OrderManagement.Domain.Bases.OrderRejectionTypeReadOnly", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Title_En = "PhoneNumberAndNationalCodeConflict"
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Title_En = "DoesntHadQualifiedDrivingLicense"
                        },
                        new
                        {
                            Id = 3,
                        ...
                        new
                        {
                            ...
                            Title_En = "OrderRegisteredInInternalVehicleSite"
                        },
                        new
                        {
                            Id = 5,
                            ...
                            Title_En = "SaipaVehicleManufactureList"
                        },
                        new
                        {
                            Id = 6,
                            ...
                            Title_En = "IkcoVehicleManufactureList"
                        },
                        new
                        {
                            Id = 7,
                            ...
                            Title_En = "KermanMotorVehicleManufactureList"
                        },
                        new
                        {
                            Id = 8,
                            ...
                            Title_En = "IliaAutoVehicleManufactureList"
                        },
                        new
                        {
                            Id = 9,
                            ...
                            Title_En = "FardaMotorsVehicleManufactureList"
                        },
                        new
                        {
                            Id = 10,
                            ...
                            Title_En = "ArianParsVehicleManufactureList"
                        },
                        new
                        {
                            Id = 11,
                            ...
                            Title_En = "MaxMotorVehicleManufactureList"
                        },
                        new
                        {
                            Id = 12,
                            ...
                            Title_En = "BahmanMotorVehicleManufactureList"
                        },
                        new
                        {
                            Id = 13,
                            ...
                            Title_En = "MvmVehicleManufactureList"
                        },
                        new
                        {
                            Id = 14,
            ...
            modelBuilder.Entity("OrderManagement.Domain.CustomerPriority", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("ApproximatePriority")
                        .HasColumnType("int");

                    b.Property<int>("ChosenPriorityByCustomer")
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "Uid" }, "IX_CustomerPriority_Uid");

                    b.ToTable("CustomerPriority", (string)null);
                });
            ...
            modelBuilder.Entity("OrderManagement.Domain.SeasonCompanyProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SeasonCompanyProduct", (string)null);
                });
            ...
            modelBuilder.Entity("OrderManagement.Domain.SeasonCompanyProduct", b =>
                {
                    b.HasOne("OrderManagement.Domain.OrderManagement.ProductAndCategory", "Company")
                        .WithMany("SeasonCompanyProducts_Company")
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("OrderManagement.Domain.OrderManagement.ProductAndCategory", "Product")
                        .WithMany("SeasonCompanyProducts_Product")
                        .HasForeignKey("ProductId");
            ...
            modelBuilder.Entity("OrderManagement.Domain.ESaleType", b =>
                {
                    ...
                    b.Navigation("SeasonCompanyProducts");
                });
            ...
            modelBuilder.Entity("OrderManagement.Domain.OrderManagement.ProductAndCategory", b =>
                {
                    ...
                    b.Navigation("SeasonCompanyProducts_Company");

                    b.Navigation("SeasonCompanyProducts_Product");
                });
