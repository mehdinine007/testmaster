...
namespace OrderManagement.EfCore.Migrations
{
    ...
    [Migration("20230527090835_Add_Agency_And_Mapp_Entities")]
    partial class AddAgencyAndMappEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderManagement.Domain.Agency_SaleDetail_Map", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Agency_SaleDetail_Map", (string)null);
                });
            ...
            modelBuilder.Entity("OrderManagement.Domain.Agency_SaleDetail_Map", b =>
                {
                    b.HasOne("OrderManagement.Domain.Agency", "Agency")
                        .WithMany("Agency_SaleDetail_Maps")
                        .HasForeignKey("AgencyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OrderManagement.Domain.SaleDetail", "SaleDetail")
                        .WithMany("AgencySaleDetailMaps")
            ...
            modelBuilder.Entity("OrderManagement.Domain.Agency", b =>
                {
                    b.Navigation("Agency_SaleDetail_Maps");
                });
            ...
            modelBuilder.Entity("OrderManagement.Domain.SaleDetail", b =>
                {
                    b.Navigation("AgencySaleDetailMaps");
