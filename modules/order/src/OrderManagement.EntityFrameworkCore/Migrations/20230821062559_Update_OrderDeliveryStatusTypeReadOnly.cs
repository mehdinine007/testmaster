...
{
    /// <inheritdoc />
    public partial class UpdateOrderDeliveryStatusTypeReadOnly : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                values: new object[] { "شماره سفارش {0}", "OrderRegistered" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                columns: new[] { "Description", "Title_En" },
                values: new object[] { "", "Prioritization" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                columns: new[] { "Description", "Title_En" },
                values: new object[] { "خودرو شما {0} می باشد", "ProductDetermination" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 4,
                columns: new[] { "Description", "Title_En" },
                values: new object[] { "ارسال به خودرو ساز ({0})", "SendingToManufaturer" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 5,
                columns: new[] { "Description", "Title_En" },
                values: new object[] { "شماره قرارداد {0}", "ReceivingContractRowId" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 6,
                columns: new[] { "Description", "Title_En" },
                values: new object[] { "مبلغ پرداختی {0}", "ReceivingAmountCompleted" });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: new[] { "Description", "Title_En" },
                values: new object[] { "لورم اپیسوم", null });
