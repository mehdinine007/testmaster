...
{
    /// <inheritdoc />
    public partial class AddOrderstatusInquiry : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InquiryFullResponse = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrderId = table.Column<int>(type: "int", nullable: false),
                    ClientNationalCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderStatusInquiry", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderStatusInquiry_ProductAndCategory_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderStatusInquiry_CompanyId",
