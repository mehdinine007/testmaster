...
{
    /// <inheritdoc />
    public partial class UpdateOrderStatusInquiry : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "OrderDeliveryStatusTypeReadOnly",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDeliveryStatusTypeReadOnly", x => x.Id);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "ثبت سفارش", "OrderRegistered" },
                    { 2, 2, "الویت بندی", "Prioritization" },
                    { 3, 3, "تعیین خودرو", "ProductDetermination" },
                    { 4, 4, "ارسال به خودرو ساز", "SendingToManufaturer" },
                    { 5, 5, "دریافت ردیف قرارداد", "ReceivingContractRowId" },
                    { 6, 6, "تکمیل وجه", "ReceivingAmountCompleted" }
                });
