...
{
    /// <inheritdoc />
    public partial class AddQuestionnaireType : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "QuestionnaireTypeReadOnly",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionnaireTypeReadOnly", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnAuthorizedUser", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnAuthorizedUser_Questionnaire_QuestionnaireId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "احراض اختیاری", "AnonymousAllowed" },
                    { 2, 2, "احراض اجباری", "AuthorizedOnly" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnAuthorizedUser_QuestionnaireId",
                table: "UnAuthorizedUser",
                column: "QuestionnaireId");

            migrationBuilder.AddForeignKey(
                name: "FK_Announcement_ProductAndCategory_CompanyId",
                table: "Announcement",
                column: "CompanyId",
