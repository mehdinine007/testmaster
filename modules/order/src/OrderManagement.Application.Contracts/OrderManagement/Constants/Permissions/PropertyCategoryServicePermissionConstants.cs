...
{
    public class PropertyCategoryServicePermissionConstants
    {
        ...
        public const string ServiceIdentifier = "0013";
        public const string ServiceDisplayName = "سرویس انتصاب محصول به ویژگی";
    }
}
