...
{
    public class ChartStructureServicePermissionConstants 
    {
        ...
        public const string ServiceIdentifier = "0017";
        public const string ServiceDisplayName = "نمایش ساختار محصول";
    }
