...
{
    public class ProductLevelServicePermissionConstants
    {
        ...
        public const string ServiceIdentifier = "0015";
        public const string ServiceDisplayName = "سرویس سطح بندی محصول";
    }
}
